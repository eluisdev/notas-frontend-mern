    ...
    <>
      <div className='flex justify-between items-center max-sm:flex-col'>
        <div>
          ...
          <h1 className="text-3xl font-black mt-3">Mis Proyectos</h1>
          <p className="text-xl font-light text-gray-500 mt-2">Maneja y administra tus proyectos</p>

        </div>
        <nav className="my-5">
          <Link
            className=" bg-yellow-500 hover:bg-yellow-600 px-5 py-3 text-white font-bold cursor-pointer transition-colors"
            to='/projects/create'
          >Nuevo Proyecto</Link>
        </nav>
      </div>
