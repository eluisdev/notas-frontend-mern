  ...
  return (
    <>
      <div className="mx-auto max-w-3xl">
        ...
        <p className="text-xl font-light text-gray-500 mt-5">Utiliza este formulario para cambiar tu password</p>
        ...
        >
          ...
          <input
            ...
            className="bg-yellow-600 w-full p-3 text-white uppercase font-bold hover:bg-yellow-700 cursor-pointer transition-colors"
          />
        </form>
      </div>
    </>
